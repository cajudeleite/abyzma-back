...
Cupon.create(name: 'Cupon 1', percentage: true,  active: true, value: 10, amount: 100, end_date: Date.today + 1.year)
Cupon.create(name: 'Cupon 2', percentage: false, active: true, value: 20, amount: 200, end_date: Date.today + 1.year)
Cupon.create(name: 'Cupon 3', percentage: true,  active: true, value: 30, amount: 300, end_date: Date.today + 1.year)
...
Ticket.create(phase: Phase.first, client_name: 'John Doe', client_email: 'john.doe@example.com', payment_id: '1234567890', price: 100)